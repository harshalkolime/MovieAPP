...
export const Header = () => {
  ...
  const activeClass = "flex flex-col dark:text-white p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
  const inActiveClass = "block py-2 dark:text-white pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
      ...
      <nav className=" drop-shadow-2xl  bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center">
            <img src={temp2} className=" h-12 mr-3" alt="Flowbite Logo" />
            <span className="self-center text-3xl font-semibold whitespace-nowrap dark:text-white">CineMate</span>
          </Link>

          <div id="mobile-nav" className="flex items-center md:order-2">

            <button type="button" onClick={() => (setDarkMode(!darkMode))} data-collapse-toggle="navbar-search-example-toggle-dark-mode-tooltip" aria-controls="navbar-search" aria-expanded="false" className="md: bg-gray-200 text-gray-900 dark:text-gray-400 dark:bg-slate-700 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray00 rounded-lg text-sm p-2 h-8 mr-6 items-center" >   
            ...
            <button id="nav-links" onClick={() => setHidden(!hidden)} data-collapse-toggle="navbar-search" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
